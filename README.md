...
Al-hacking is a script I made in python 3. With this tool, you can easily find Google sites. Al-hacking collects potentially vulnerable web pages and applications on the Internet or other awesome info that is picked up by Google's search bots. 
...
You can also use Al-hacking as a command-line interface (CLI) to quickly search through Google. Al-hacking shows only the links, without advertising, and is and is also fast!! (:)
...
Al-hacking is written for Python 3. Clone the git repository and install the requirements.
****



# Linux
sudo git clone https://github.com/bensmit033-sketch/Al-hacking.git

cd Al-hacking

pip3 install -r requirements.txt

# Al-hacking Usage Linux

sudo python3 Al-hacking.py
****
