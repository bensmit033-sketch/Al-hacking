...
try:
    ...
    print("\n[!] Error: 'googlesearch' module is not installed.")
    print("[!] Please run: pip install googlesearch-python\n")
    sys.exit()
...
if sys.version[0] in "2":
    print ("\n[:(] AL-HACKING is not supported for Python 2. Use Python 3 to continue!! \n")
    print ("\n[:)]  THANKS FOR USING AL-HACKING!! ;)\n\n")
    exit()
...
x = ("""
                Author:  bensmit033
                Github:  https://github.com/bensmit033-sketch""")
for col in x:
...
def dorks():
    try:
        dork = input("\n[:)] What do you want AL-HACKING to look for!!: ")
